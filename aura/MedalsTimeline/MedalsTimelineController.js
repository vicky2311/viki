({
	scriptsLoaded : function(component, event, helper) {
        ...
        var years = window.backupService.getData();
        ...
        years.forEach(function(year) {
            ...
            year.Orgs.forEach(function(country) {
                var total = country.Q1 + country.Q2 + country.Q3;
                if (countries[country.Org]) {
                	countries[country.Org].push(total);    
                } else {
                 	countries[country.Org] = [total];   
                }
            })
        });
